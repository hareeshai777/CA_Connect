...
- Name: 01-auth.spec.ts >> Authentication — all roles >> CA user accessing /client/dashboard redirects to CA dashboard
- Location: tests/e2e/01-auth.spec.ts:72:7
    ...
    - generic [ref=e34]:
      ...
      - generic [ref=e49]:
        - generic [ref=e50]:
          ...
          - generic [ref=e51]:
            - img [ref=e52]
            - textbox "you@example.com" [ref=e55]: ca@demo.com
        - generic [ref=e56]:
          - generic [ref=e57]:
