...
- Name: 05-assistance.spec.ts >> ASSISTANCE TEAM workflow >> Team Chat message input is present
- Location: tests/e2e/05-assistance.spec.ts:145:7
...
Locator: locator('input[placeholder*=\'message\' i]')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('input[placeholder*=\'message\' i]')
