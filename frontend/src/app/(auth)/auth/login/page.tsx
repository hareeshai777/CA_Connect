...
function LoginContent() {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      if (redirect && role === "CLIENT") router.push(redirect);
  ...
  return (
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-500">Sign in to your CAConnect account</p>
      </div>

      {/* Google sign-in */}
      <button
        type="button"
        onClick={() => toast.info("Google Sign-In: Configure Google OAuth in settings")}
        className="w-full flex items-center justify-center gap-3 h-12 rounded-xl border-2 border-gray-200 bg-white hover:bg-gray-50 hover:border-gray-300 transition-all font-medium text-gray-700 mb-6 shadow-sm"
      >
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
        <div className="space-y-1.5">
          ...
          <div className="relative">
            ...
            <Input
              ...
              className="pl-10 h-12 rounded-xl border-gray-200 focus:border-blue-500 focus:ring-blue-500/20 bg-gray-50 focus:bg-white transition-colors"
              {...register("email")}
            />
          </div>
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative">
            ...
            <Input
              ...
              placeholder="••••••••"
              className="pl-10 pr-10 h-12 rounded-xl border-gray-200 focus:border-blue-500 focus:ring-blue-500/20 bg-gray-50 focus:bg-white transition-colors"
              {...register("password")}
            />
            <button
              type="button"
        ...
        <Button
          type="submit"
          className="w-full h-12 rounded-xl bg-blue-600 hover:bg-blue-700 font-bold text-base shadow-lg shadow-blue-600/25 border-0"
          disabled={loading}
        >
          {loading ? (
