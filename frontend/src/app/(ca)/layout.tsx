...
import { Briefcase, LayoutDashboard, Calendar, Users, CreditCard, User, MessageCircle, LogOut, Bell, FileText, TrendingUp, Clock, Settings } from "lucide-react";
...
const navItems = [
  ...
  { href: "/ca/ai-assistant", icon: MessageCircle, label: "AI Assistant" },
